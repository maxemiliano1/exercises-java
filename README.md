# Java Fundamentals & Backend Development

Este repositório é dedicado à consolidação de conceitos essenciais da linguagem Java e ao desenvolvimento de lógica de programação.
...
## ⚙️ Execução
As classes estão estruturadas para execução via CLI ou através da própria IDE, mantendo o padrão de organização por pacotes técnicos.
